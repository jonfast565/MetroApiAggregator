...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/metroapiaggregator: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/metroapiaggregator ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/HTTPRequestBuilder.o: HTTPRequestBuilder.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HTTPRequestBuilder.o HTTPRequestBuilder.cpp
